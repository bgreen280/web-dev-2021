...
// 11 Don’t forget to test your function! Check off this task when you’ve finished testing.
...
// Solution:
// create function to get user choice and validate input
...
// test computer generated choice
// console.log(getComputerChoice())
// console.log(getComputerChoice())
// console.log(getComputerChoice())

// function to determine winner of user and computer 
function determineWinner(userChoice, computerChoice) {

  if (userChoice === 'bomb') {
    return 'Player found the cheat code and player won!'
...
function playGame() {
  const userChoice = getUserChoice('rock'); // get user choice
  const computerChoice = getComputerChoice(); // create computer choice
  // console.log(userChoice); // test user choice
  // console.log(computerChoice);  // test computer choice
